...
<fieldset>
	...
	<?php  
			if ( $value[ 'texto' ] == 'Esta Mensagem foi excluida por: '.$usuario
	...
	<p id='belezaDoEnviante' style="color: white;
	...
	<div>
		<p id='belezaDaSmsEnviante'> <?php	echo $value[ 'texto' ];
    ?> </p>
	</div>
	...
	<p id='belezaDoReceptor' style="color: white;
